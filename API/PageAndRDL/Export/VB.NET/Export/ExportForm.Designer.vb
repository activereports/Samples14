...
Partial Class ExportForm
	...
	Private Sub InitializeComponent()
		...
		Me.exportTypes.Items.AddRange(New Object() {resources.GetString("exportTypes.Items"), resources.GetString("exportTypes.Items1"), resources.GetString("exportTypes.Items2"), resources.GetString("exportTypes.Items3"), resources.GetString("exportTypes.Items4"), resources.GetString("exportTypes.Items5")})
